...
//		q.sort().on("rank", Order.DESCENDING);
	 ...
	 * 
	 * @see ConnectionService#create(String, Connection, int)
	 */
	@Override
	 ...
	 * Update a connection.
	 * 
	 * @see ConnectionService#update(String, Connection)
	 */
	@Override
	 ...
	 * Remove a connection.
	 * 
	 * @see ConnectionService#remove(String, ConnectionKey)
	 */
	@Override
